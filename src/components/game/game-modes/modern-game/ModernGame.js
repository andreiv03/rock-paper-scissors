...
export default function LegacyGame() {
  ...
  return (
    <motion.div className="modern-game" animate={containerControls}>
        ...
        <AnimatePresence>
          {
            !userItem && items.map(item => (
              <motion.div
                key={item}
                className={`modern-game__item modern-game__${item}`}
                ...
                exit={exitAnimation}
              >
                <div className="modern-game__item-inner">
          ...
          {
            !userItem && (
              <motion.div className="modern-game-layout" exit={exitAnimation}>
                <div className="modern-game-layout__line"></div>
                <div className="modern-game-layout__line"></div>
                <div className="modern-game-layout__line"></div>
                <div className="modern-game-layout__line"></div>
                <div className="modern-game-layout__line"></div>
